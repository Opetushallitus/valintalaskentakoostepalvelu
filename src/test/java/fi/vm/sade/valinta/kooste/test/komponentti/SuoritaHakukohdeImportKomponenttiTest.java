...
public class SuoritaHakukohdeImportKomponenttiTest {
	...
	public void test() throws IOException {
		...
		HakukohdeNimiRDTO nimi = mapper.readValue(Resources.toString(
				Resources.getResource(HAKUKOHDE_NIMI_JSON), Charsets.UTF_8),
				HakukohdeNimiRDTO.class);
		HakukohdeDTO hakukohde = mapper.readValue(Resources.toString(
				Resources.getResource(HAKUKOHDE_JSON), Charsets.UTF_8),
				HakukohdeDTO.class);
		HakukohdeValintaperusteetV1RDTO valintaperusteet = mapper.readValue(
				Resources.toString(
						Resources.getResource(HAKUKOHDE_VALINTAPERUSTEET_JSON),
						Charsets.UTF_8), HakukohdeValintaperusteetV1RDTO.class);
		ResultV1RDTO<HakukohdeValintaperusteetV1RDTO> result = new ResultV1RDTO<>();
		result.setResult(valintaperusteet);
		List<KoodistoUrheilija> alakoodit = mapper.readValue(Resources
				.toString(Resources.getResource(KOODISTO_ALAKOODIT_JSON),
						Charsets.UTF_8), TypeFactory.defaultInstance()
