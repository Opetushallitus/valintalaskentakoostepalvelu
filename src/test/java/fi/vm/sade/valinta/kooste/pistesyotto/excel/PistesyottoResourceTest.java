...
public class PistesyottoResourceTest {
    ...
    final HttpResourceBuilder.WebClientExposingHttpResource pistesyottoTuontiResource = new HttpResourceBuilder(getClass().getName())
            .address(root + "/pistesyotto/tuonti").buildExposingWebClientDangerously();
    final HttpResourceBuilder.WebClientExposingHttpResource pistesyottoVientiResource = new HttpResourceBuilder(getClass().getName())
            .address(root + "/pistesyotto/vienti").buildExposingWebClientDangerously();
    final HttpResourceBuilder.WebClientExposingHttpResource pistesyottoUlkoinenTuontiResource = new HttpResourceBuilder(getClass().getName())
    ...
    public void pistesyottoVientiTest() throws Throwable {
        ...
        try {
            ...
            Mockito.when(Mocks.getValintapisteAsyncResource().getValintapisteetWithHakemusOidsAsFuture(Mockito.eq(vientiHakemukset), Mockito.any(AuditSession.class)))
    ...
    public void pistesyottoVienti2Test() throws Throwable {
        ...
        try {
            ...
            Mockito.when(Mocks.getValintapisteAsyncResource().getValintapisteet(Mockito.anyCollectionOf(String.class), Mockito.any(AuditSession.class)))
                .thenReturn(Observable.just(new PisteetWithLastModified(Optional.empty(), Collections.emptyList())));
            Mockito.when(Mocks.getValintapisteAsyncResource().getValintapisteetWithHakemusOidsAsFuture(Mockito.eq(HAKEMUS_OIDS), Mockito.any(AuditSession.class)))
