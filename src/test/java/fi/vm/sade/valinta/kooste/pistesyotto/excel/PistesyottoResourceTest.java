...
public class PistesyottoResourceTest {
  ...
  final HttpResourceBuilder.WebClientExposingHttpResource pistesyottoVientiResource =
      new HttpResourceBuilder(getClass().getName())
          .address(root + "/pistesyotto/vienti")
          .buildExposingWebClientDangerously();
  final HttpResourceBuilder.WebClientExposingHttpResource pistesyottoUlkoinenTuontiResource =
      new HttpResourceBuilder(getClass().getName())
          .address(root + "/pistesyotto/ulkoinen")
          .buildExposingWebClientDangerously();
  ...
  private final List<HakemusWrapper> hakemukset =
      Arrays.asList(
          hakemus()
              .setOid(HAKEMUS1)
  ...
  private final List<ValintakoeOsallistuminenDTO> osallistumistiedot =
      Arrays.asList(
          osallistuminen()
          ...
          osallistuminen()
              ...
              .build()
              .build());
  private final List<ValintaperusteDTO> valintaperusteet =
      Arrays.asList(
          valintaperuste()
              .setKuvaus(TUNNISTE1)
              .setTunniste(TUNNISTE1)
  ...
  private final OrganisaatioTyyppiHierarkia kielikokeitaJarjestavanOppilaitoksenHierarkia =
      new OrganisaatioTyyppiHierarkia(
          1,
          Collections.singletonList(
              new OrganisaatioTyyppi(
                  KIELIKOE_KOULUTUSTOIMIJA_OID,
                  ImmutableMap.of("fi", "Itä-Savon koulutuskuntayhtymä"),
                  Collections.singletonList(
                      new OrganisaatioTyyppi(
                          KIELIKOE_OPPILAITOS_OID,
  ...
  private final Response okResponse =
      Response.ok("Success in " + getClass().getSimpleName()).build();
  private PistesyottoExcel pistesyottoExcel =
  ...
  public void pistesyottoUlkoinenTuontiResource() throws Exception {
    ...
    HakemusWrapper hakemus1 =
        new HakemusSpec.HakemusBuilder()
            .setOid(hakemusOid1)
            .addHakutoive(hakukohdeOid1)
            .setPersonOid(hakemusPersonOid1)
            .setEtunimiJaSukunimi("Etunimi", "Sukunimi")
            .build();
    HakemusWrapper hakemus2 =
        new HakemusSpec.HakemusBuilder()
            .setOid(hakemusOid2)
            .addHakutoive(hakukohdeOid1)
            .setPersonOid(hakemusPersonOid2)
            .setEtunimiJaSukunimi("Etunimi", "Sukunimi")
            .build();
    HakemusWrapper hakemus3 =
        new HakemusSpec.HakemusBuilder()
            .setOid(hakemusOid3)
            .addHakutoive(hakukohdeOid1)
            .setPersonOid(hakemusInvalidPersonOid3)
            .setEtunimiJaSukunimi("Etunimi", "Sukunimi")
            .build();
    HakemusWrapper hakemus4 =
        new HakemusSpec.HakemusBuilder()
            .setOid(hakemusOid4)
            .addHakutoive(hakukohdeOid1)
            .setPersonOid(hakemusPersonOid4)
            .setEtunimiJaSukunimi("Etunimi", "Sukunimi")
            .build();
    HakemusWrapper hakemus5 =
        new HakemusSpec.HakemusBuilder()
            .setOid(hakemusOid5)
            .addHakutoive(hakukohdeOid2)
            .setPersonOid(hakemusPersonOid5)
            .setEtunimiJaSukunimi("Etunimi", "Sukunimi")
            .build();

    List<HakemusWrapper> hakemuses =
        Arrays.asList(hakemus1, hakemus2, hakemus3, hakemus4, hakemus5);
    MockApplicationAsyncResource.setResult(hakemuses);
    MockApplicationAsyncResource.setResultByOid(hakemuses);

    HakukohdeJaValintaperusteDTO vp =
        new HakukohdeJaValintaperusteDTO(
            hakukohdeOid1,
            Arrays.asList(
                new ValintaperusteetSpec.ValintaperusteBuilder()
                    .setTunniste(tunniste1)
                    .setLukuarvofunktio()
                    .setArvot("8.34", "5.00")
                    .build(),
                new ValintaperusteetSpec.ValintaperusteBuilder()
                    ...
                    .setMin("5.00")
                    .build()));
    HakukohdeJaValintaperusteDTO vp2 =
        new HakukohdeJaValintaperusteDTO(
            hakukohdeOid2,
            Arrays.asList(
                new ValintaperusteetSpec.ValintaperusteBuilder()
    ...
    HakukohdeJaValintakoeDTO vk =
        new HakukohdeJaValintakoeDTO(
            hakukohdeOid1,
            Arrays.asList(
                new ValintaperusteetSpec.ValintakoeDTOBuilder()
                    .setTunniste(tunniste1)
                    .setKaikkiKutsutaan()
                    .build(),
                new ValintaperusteetSpec.ValintakoeDTOBuilder()
    ...
    Mockito.when(
            Mocks.getValintapisteAsyncResource()
                .getValintapisteet(
                    Mockito.eq(HAKU1), Mockito.eq(HAKUKOHDE1), Mockito.any(AuditSession.class)))
        .thenReturn(
    ...
    List<ValintakoeOsallistuminenDTO> osallistuminenDTOs =
        Arrays.asList(
            new ValintalaskentaSpec.ValintakoeOsallistuminenBuilder()
                .hakutoive()
                .setHakukohdeOid(hakukohdeOid1)
                .build()
                .build());
    ...
    String requestBody =
        IOUtils.toString(
            new ClassPathResource("pistesyotto/ulkoinen_tuonti.json").getInputStream());
    List<HakemusDTO> hakemusDTOs =
        pistesyottoVientiResource
            .gson()
            .fromJson(requestBody, new TypeToken<List<HakemusDTO>>() {}.getType());
    assertEquals(6, hakemusDTOs.size());
    Response response =
        pistesyottoUlkoinenTuontiResource
            .getWebClient()
  ...
  public void pistesyottoUlkoinenTuontiResourceWithBadInput() {
    ...
    ValintakoeDTO koeToInput =
        new ValintakoeDTO(tunniste1, ValintakoeDTO.Osallistuminen.OSALLISTUI, "5.00");
    List<HakemusDTO> hakemusesToInput =
        Collections.singletonList(
            new HakemusDTO(hakemusOid1, hakemusPersonOid1, Collections.singletonList(koeToInput)));
    ...
    ArrayList<JsonElement> errors =
        Lists.newArrayList(badResponseJson.get("virheet").getAsJsonArray());
    assertThat(errors, hasSize(1));
    assertThat(
        errors.get(0).getAsJsonObject().get("virhe").getAsString(),
        equalTo(
  ...
  public void pistesyottoVientiTest() throws Throwable {
    ...
    try {
      ...
      MockApplicationAsyncResource.setResultByOid(
          Arrays.asList(
              hakemus()
                  ...
                  .build()));
      List<ApplicationAdditionalDataDTO> additionalDataResult =
          Arrays.asList(
              lisatiedot().setOid(HAKEMUS1).setEtunimiJaSukunimi("Hilla", "Hiiri").build());
      MockApplicationAsyncResource.setAdditionalDataResult(additionalDataResult);
      List<ApplicationAdditionalDataDTO> additionalDataResultByOid =
          Arrays.asList(
              lisatiedot().setOid(HAKEMUS2).setEtunimiJaSukunimi("Hellevi", "Hiiri").build());
      ...
      Mockito.when(
          ...
          .thenReturn(
              CompletableFuture.completedFuture(
                  new PisteetWithLastModified(Optional.empty(), kaikkiPisteet)));
              ...
              .filter(
                  rivi ->
                      rivi.getSolut().stream()
                          .anyMatch(solu -> HAKEMUS1.equals(solu.toTeksti().getTeksti())))
              .findFirst()
              .get();
      assertRivi(
          hakemus1Rivi,
      ...
      Rivi hakemus2Rivi =
          rivit.stream()
              .filter(
                  rivi ->
                      rivi.getSolut().stream()
                          .anyMatch(solu -> HAKEMUS2.equals(solu.toTeksti().getTeksti())))
              .findFirst()
              .get();
      assertRivi(
          hakemus2Rivi,
  ...
  public void pistesyottoTuontiTest() {
    ...
    try {
      ...
      List<ApplicationAdditionalDataDTO> additionalDataResult =
          Arrays.asList(
              lisatiedot().setOid(HAKEMUS1).setEtunimiJaSukunimi("Etunimi", "Sukunimi").build());
      MockApplicationAsyncResource.setAdditionalDataResult(additionalDataResult);
      List<ApplicationAdditionalDataDTO> additionalDataResultByOid =
          Arrays.asList(
  ...
  public void pistesyottoTuontiVirheellisestiSortatuillaHakemuksillaTest() {
    ...
    try {
      ...
      MockApplicationAsyncResource.setAdditionalDataResult(
          Arrays.asList(
              lisatiedot().setEtunimiJaSukunimi("Essi1", "Hakemus1").setOid(HAKEMUS1).build(),
              lisatiedot().setOid(HAKEMUS3).build()));
      MockApplicationAsyncResource.setAdditionalDataResultByOid(
          Arrays.asList(
              lisatiedot().setEtunimiJaSukunimi("Esko2", "Hakemus2").setOid(HAKEMUS2).build(),
      ...
      Response r =
          pistesyottoTuontiResource
              ...
              .post(
                  Entity.entity(
                      PistesyottoResourceTest.class.getResourceAsStream(
                          "/virheellisesti_sortattu_excel.xlsx"),
    ...
    try {
      ...
      Mockito.when(
          ...
          .thenReturn(
              Observable.just(
                  new PisteetWithLastModified(
                      Optional.empty(), asValintapisteet(applicationAddtionalDataDtosByOid))));
      Mockito.when(
              Mocks.getValintapisteAsyncResource()
                  .getValintapisteet(
                      Mockito.eq(HAKU1), Mockito.eq(HAKUKOHDE1), Mockito.any(AuditSession.class)))
          .thenReturn(
              CompletableFuture.completedFuture(
                  new PisteetWithLastModified(
                      Optional.empty(), asValintapisteet(applicationAdditionalDataDtos))));
      Mockito.when(
              Mocks.getValintapisteAsyncResource()
                  .putValintapisteet(
                      Mockito.eq(Optional.empty()),
      ...
      MockOrganisaationAsyncResource.setOrganisaationTyyppiHierarkia(
          kielikokeitaJarjestavanOppilaitoksenHierarkia);
      MockSuoritusrekisteriAsyncResource.setPostException(
          Optional.of(
              new HttpExceptionWithResponse(
                  "Something terrible happened", Response.serverError().entity("Boom").build())));
      ...
      Response r =
          pistesyottoTuontiResource
              ...
              .post(
                  Entity.entity(
                      pistesyottoExcel.getExcel().vieXlsx(), MediaType.APPLICATION_OCTET_STREAM));
      assertEquals(500, r.getStatus());
    } finally {
  ...
  public void pistesyottoTuonti3Test() {
    ...
    try {
      ...
      assertThat(
          "Suresta löytyy oikea kielikoesuoritus",
          MockSuoritusrekisteriAsyncResource.suorituksetRef.get(),
      ...
      assertThat(
          "Oikea arvosana on deletoitu",
          MockSuoritusrekisteriAsyncResource.deletedArvosanatRef.get(),
      ...
      PistesyottoExcel excel =
          new PistesyottoExcel(
              ...
              Collections.singletonList(
                  hakemus().setOid(HAKEMUS1).setEtunimiJaSukunimi("Etunimi", "Sukunimi").build()),
              Sets.newHashSet(
                  Collections.singletonList(VALINTAKOE1)), // KAIKKI KUTSUTAAN TUNNISTEET
              Collections.singletonList(VALINTAKOE1), // TUNNISTEET
              osallistumistiedot,
              valintaperusteet,
              Collections.singletonList(
