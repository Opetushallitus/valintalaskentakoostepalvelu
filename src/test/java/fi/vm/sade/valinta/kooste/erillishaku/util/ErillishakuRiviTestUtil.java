...
public class ErillishakuRiviTestUtil {
    ...
    public static ErillishakuRivi laillinenRivi() {
        return new ErillishakuRivi(SUKUNIMI,ETUNIMI,HETU,SYNTYMAAIKA,StringUtils.EMPTY, HakemuksenTila.HYVAKSYTTY.toString(), ValintatuloksenTila.VASTAANOTTANUT.toString(), IlmoittautumisTila.EI_ILMOITTAUTUNUT.toString(),true);
    }
