...
@ContextConfiguration(classes = {
		HakukohteenValintakoelaskentaKoosteReititysTest.class,
...
public class HakukohteenValintakoelaskentaKoosteReititysTest {
	...
	public void test() throws JSONException {
		...
		hakukohteenValintakoelaskentaRoute
				.aktivoiValintakoelaskenta(HAKUKOHDE_OID);
