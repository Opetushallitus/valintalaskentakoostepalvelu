...
public class ErillishakuExcelTest {
	...
	public void testaaVienti() throws IOException {
		...
		ErillishakuRivi rivi = new ErillishakuRivi(
				null, "sukunimi","etunimi1","hetu","test.email@example.com", syntymaAika, Sukupuoli.MIES.name(), "", "FI", "HYLATTY", "", "", false, false, "FI",
				"040123456789", "Esimerkkitie 2", "00100", "HELSINKI", "FIN", "FIN", "HELSINKI", null);
		rivit.add(rivi);
		ErillishakuRivi rivi2= new ErillishakuRivi(null, "sukunimi","etunimi2","hetu","test.email@example.com", syntymaAika, Sukupuoli.NAINEN.name(), "", "FI", "HYLATTY", "", "", true, false, "FI",
