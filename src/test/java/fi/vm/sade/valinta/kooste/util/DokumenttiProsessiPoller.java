...
public class DokumenttiProsessiPoller {
    ...
    public static void pollDokumenttiProsessi(String rootUrl, ProsessiId prosessiId, Function<Prosessi,Boolean> responseProcessor) {
        ...
        fail("Did not complete within " + TIME_TO_WAIT_IN_TOTAL.toMillis() + " ms.");
    }
}
