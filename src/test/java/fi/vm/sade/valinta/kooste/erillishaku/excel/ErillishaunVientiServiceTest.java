...
public class ErillishaunVientiServiceTest {
    ...
    public void suoritaVientiTest() {
        ...
        final ErillishaunVientiService erillishaunVientiService =
                new ErillishaunVientiService(mockTilaAsyncResource, mockApplicationAsyncResource, mockAtaruAsyncResource, mockTarjontaAsyncService, mockDokumenttiResource, mockKoodistoCachedAsyncResource);
    ...
    public void suoriteVientiIlmanhakemuksia() throws IOException {
        ...
        final ErillishaunVientiService erillishaunVientiService =
                new ErillishaunVientiService(mockTilaAsyncResource, applicationMock, mockAtaruAsyncResource, mockTarjontaAsyncService, mockDokumenttiResource, mockKoodistoCachedAsyncResource);
        erillishaunVientiService.vie(new AuditSession(), prosessi, erillishaku);
