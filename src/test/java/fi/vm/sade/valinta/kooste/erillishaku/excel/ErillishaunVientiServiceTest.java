...
public class ErillishaunVientiServiceTest {
    ...
    public void suoritaVientiTest() {
        ...
        final ErillishaunVientiService erillishaunVientiService =
                new ErillishaunVientiService(mockTilaAsyncResource, mockApplicationAsyncResource, mockTarjontaAsyncService, mockDokumenttiResource, mockKoodistoCachedAsyncResource);
    ...
    public void suoritaEpaonnistunutVientiTest() {
        ...
        final ErillishaunVientiService erillishaunVientiService =
                new ErillishaunVientiService(mockTilaAsyncResource, failingResource, mockTarjontaAsyncService, mockDokumenttiResource, mockKoodistoCachedAsyncResource);
    ...
    public void suoriteVientiIlmanhakemuksia() throws IOException {
        ...
        final ErillishaunVientiService erillishaunVientiService =
                new ErillishaunVientiService(mockTilaAsyncResource, applicationMock, mockTarjontaAsyncService, mockDokumenttiResource, mockKoodistoCachedAsyncResource);
        erillishaunVientiService.vie(new AuditSession(), prosessi, erillishaku);
