...
public class ValintatapajonoTuontiTest extends ValintatapajonoTestTools {
  ...
  private static final Type valinnanVaiheListType =
      new TypeToken<ArrayList<ValintatietoValinnanvaiheDTO>>() {}.getType();
  ...
  public void testaaValintatapajonoTuonti() throws Exception {
    List<ValintatietoValinnanvaiheDTO> valinnanvaihe =
        GSON.fromJson(resurssi("valinnanvaihe.json"), valinnanVaiheListType);
    ...
    ValintatapajonoExcel valintatapajonoExcel =
        new ValintatapajonoExcel(
            ...
            "14017934785463582418268204255542",
            "Haun Nimi",
            "Hakukohteen Nimi",
            valinnanvaihe,
  ...
  private void assertLines(List<ValintatapajonoRivi> rivit) {
    ...
    assertRivi(
        new ValintatapajonoRivi(
            "1.2.246.562.11.00000860732",
            "1.0",
            "Huisnen Elina",
            ValintatapajonoExcel.HYVAKSYTTAVISSA,
            "",
            null,
            null,
            null),
    ...
    assertRivi(
        new ValintatapajonoRivi(
            "1.2.246.562.11.00000873703",
            "5.0",
            "Hoppusalo Pinja",
            ValintatapajonoExcel.HYLATTY,
            "",
            "fuyf",
            "uyf",
            "ft"),
    ...
    assertRivi(
        new ValintatapajonoRivi(
            "1.2.246.562.11.00000846727",
            "",
            "Kaksilahti Kasper",
            ValintatapajonoExcel.MAARITTELEMATON,
            "",
            null,
            null,
            null),
  ...
  public void testaaValintatapajonoKokonaispisteetTuonti() throws Exception {
    ...
    valintatapajonoExcel
        .getExcel()
        .tuoXlsx(
            new ClassPathResource("valintatapajono/valintatapajono_kokonaispisteet.xlsx")
                .getInputStream());
    for (ValintatapajonoRivi r : listaus.getRivit()) {
      LOG.info("{} {} {} {}", r.getJonosija(), r.getNimi(), r.isValidi(), r.getTila());
    }
  ...
  private static String resurssi(String resurssi) throws IOException {
    ...
    String s =
        IOUtils.toString(
            i = new ClassPathResource("valintatapajono/" + resurssi).getInputStream(), "UTF-8");
