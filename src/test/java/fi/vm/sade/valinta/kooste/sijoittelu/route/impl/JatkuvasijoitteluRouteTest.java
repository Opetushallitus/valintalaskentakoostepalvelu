...
public class JatkuvasijoitteluRouteTest extends CamelTestSupport {
	...
	private final DelayQueue<DelayedSijoitteluExchange> jatkuvaSijoitteluDelayedQueue = Mockito
			.spy(new DelayQueue<>());
	...
	private final JatkuvaSijoitteluRouteImpl jatkuvaSijoitteluRouteImpl = new JatkuvaSijoitteluRouteImpl(
			jatkuvaSijoitteluTimer, sijoitteluResource,
	...
	@Test
	public void jatkuvaSijoitteluRouteTest() {
		final String HK = "hk1";
		...
		// Mockito.verify(jatkuvaSijoitteluDelayedQueue, Mockito.timeout(2000)
		// .atLeast(1));
		// Mockito.verify(ajossaHakuOids, Mockito.timeout(2000).atLeast(1))
		// .putIfAbsent(Mockito.anyString(), Mockito.anyLong());
		// Assert.assertTrue(jatkuvaSijoitteluRouteImpl.getAjossaHakuOids()
		// .contains(HK));
	}
