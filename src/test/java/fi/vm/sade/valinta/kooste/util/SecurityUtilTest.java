...
public class SecurityUtilTest {
    ...
    public void TestParseOrganizationOidFromSecurityRole() {
        ...
        Optional<String> result2 = parseOrganizationOidFromSecurityRole("auth_crud_" + ORGANIZATION_OID_PREFIX + "111.222");
    ...
    public void TestParseOrganizationGroupOidFromSecurityRole() {
        ...
        Optional<String> result2 = parseOrganizationGroupOidFromSecurityRole("auth_crud_" + ORGANIZATION_GROUP_OID_PREFIX + "222.333");
    ...
    public void TestParseOrganizationOidsFromSecurityRoles() {
        Set<String> oids = Stream.of(ORGANIZATION_OID_PREFIX + "222.333",
                                     ORGANIZATION_OID_PREFIX + "111.222")
    ...
    public void TestParseOrganizationGroupOidsFromSecurityRoles() {
        Set<String> oids = Stream.of(ORGANIZATION_GROUP_OID_PREFIX + "111.222",
                                     ORGANIZATION_GROUP_OID_PREFIX + "444.555")
                .collect(Collectors.toSet());

        Set<String> result = parseOrganizationGroupOidsFromSecurityRoles(Arrays.asList(
                "auth_crud_" + ORGANIZATION_OID_PREFIX + "222.333",
    ...
    public void TestContainsOphRole() {
        Set<GrantedAuthority> oids1 = Stream.of("auth_crud_" + ORGANIZATION_GROUP_OID_PREFIX + "111.222",
                "auth_crud_" + ORGANIZATION_GROUP_OID_PREFIX + "444.555")
                .map(TestAuthority::new)
                .collect(Collectors.toSet());
        Set<GrantedAuthority> oids2 = Stream.of("auth_crud_" + ORGANIZATION_GROUP_OID_PREFIX + "111.222",
                "auth_crud_" + ORGANIZATION_GROUP_OID_PREFIX + "444.555",
