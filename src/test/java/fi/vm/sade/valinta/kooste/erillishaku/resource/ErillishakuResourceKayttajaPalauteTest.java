...
public class ErillishakuResourceKayttajaPalauteTest {
    ...
    public void tuontiVirheitaTuoduissaTiedoissaPalaute() {
        ...
        assertThat(odotaVirhettaTaiEpaonnistuTimeouttiin(prosessiId)
                ...
                new Tunniste(
                        "Rivi 2: Henkilötunnus, syntymäaika + sukupuoli ja henkilö-oid olivat tyhjiä (vähintään yksi tunniste on syötettävä). Äidinkieli on pakollinen tieto, kun henkilötunnus ja henkilö OID puuttuvat. Pakollinen tieto \"äidinkieli\" puuttuu. Pakollinen tieto \"asuinmaa\" puuttuu. Pakollinen tieto \"kansalaisuus\" puuttuu. Pakollinen tieto \"kotikunta\" puuttuu. Pakollinen tieto \"toisen asteen pohjakoulutuksen maa\" puuttuu. : Etunimi, Sukunimi, , HYVAKSYTTY, Ei, ***HENKILOTUNNUS***, , NAINEN, , EI_ILMOITTAUTUNUT, false, null, VASTAANOTTANUT_SITOVASTI, true, null, null, null, null, null, null, null, null, null",
