...
public class HaeHaunHakemuksetKomponenttiTest {
  ...
  private static final String[] HAKEMUS_OIDS = new String[] { "1.2.3.4.5.00000000039", "1.2.3.4.5.00000000042",
      "1.2.3.4.5.00000000057", };

  private static final String HAKEMUKSET_JSON = "{" + "totalCount: 3," + "results: [" + "{" + "oid: \""
      + HAKEMUS_OIDS[0] + "\"," + "state: \"ACTIVE\"," + "firstNames: \"VXCVX XccVrVr\","
      + "lastName: \"pFUBjjes\"," + "ssn: \"300582-2022\"," + "personOid: \"1.2.246.562.24.37911437777\"" + "},"
      + "{" + "oid: \"" + HAKEMUS_OIDS[1] + "\"," + "state: \"ACTIVE\"," + "firstNames: \"ZYayxck cozVZk\","
      + "lastName: \"mqmVgddU\"," + "ssn: \"131194-1412\"," + "personOid: \"1.2.246.562.24.50174373493\"" + "},"
      + "{" + "oid: \"" + HAKEMUS_OIDS[2] + "\"," + "state: \"ACTIVE\"," + "firstNames: \"ZiUxxz-ippZz\","
      + "lastName: \"pZuuYpSpx\"," + "ssn: \"140592-174D\"," + "personOid: \"1.2.246.562.24.23811448414\"" + "}"
      + "]" + "}";
  ...
  public void test() {
    ...
    when(applicationResourceMock.findApplications(eq(null), anyList(), eq(null), eq(null), eq(hakuOid), eq(null),
        anyInt(), anyInt())).thenReturn(new Gson().fromJson(HAKEMUKSET_JSON, HakemusList.class));
