...
public class HaeHaunHakemuksetKomponenttiTest {
  ...
  private HaeHaunHakemuksetKomponentti haeHaunHakemuksetKomponentti =
      new HaeHaunHakemuksetKomponentti();
  ...
  public void setUp() {
    ...
    ReflectionTestUtils.setField(
        haeHaunHakemuksetKomponentti, "applicationResource", applicationResourceMock);
  }

  private static final String[] HAKEMUS_OIDS =
      new String[] {
        "1.2.3.4.5.00000000039", "1.2.3.4.5.00000000042", "1.2.3.4.5.00000000057",
      };

  private static final String HAKEMUKSET_JSON =
      "{"
          + "totalCount: 3,"
          + "results: ["
          + "{"
  ...
  public void test() {
    ...
    when(applicationResourceMock.findApplications(
            eq(null), anyList(), eq(null), eq(null), eq(hakuOid), eq(null), anyInt(), anyInt()))
