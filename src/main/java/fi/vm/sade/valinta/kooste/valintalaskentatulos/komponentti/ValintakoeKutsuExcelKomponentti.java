 ...
 * /haku-app/applications/listfull?appState=ACTIVE&appState=INCOMPLETE&rows=100000&asId={hakuOid}&aoOid={hakukohdeOid} @POST
 * [oids] /valintaperusteet-service/resources/valintakoe @POST [oids]
 * /valintalaskenta-laskenta-service/resources/valintatieto/hakukohde/{hakukohdeOid}
 */
