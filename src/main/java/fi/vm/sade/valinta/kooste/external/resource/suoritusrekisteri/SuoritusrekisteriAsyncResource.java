...
public interface SuoritusrekisteriAsyncResource {
  ...
  CompletableFuture<List<Oppija>> getOppijatByHakukohdeWithoutEnsikertalaisuus(String hakukohdeOid, String hakuOid);
  ...
  CompletableFuture<List<Oppija>> getSuorituksetForOppijasWithoutEnsikertalaisuus(List<String> opiskelijaOids);
