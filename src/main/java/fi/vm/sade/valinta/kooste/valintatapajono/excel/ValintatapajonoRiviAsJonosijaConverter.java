...
public class ValintatapajonoRiviAsJonosijaConverter {
	...
	public static JonosijaDTO convert(String hakukohdeOid,
			ValintatapajonoRivi rivi, Hakemus hakemus) {
		...
		if (prioriteetti == null) {
			throw new RuntimeException(
					"Hakemuspalvelu palautti hakemuksen hakukohteelle vaikka hakija ei ole siihen hakenut!");
		}
		j.setPrioriteetti(prioriteetti);
		JarjestyskriteeritulosDTO kriteeri = new JarjestyskriteeritulosDTO();
		kriteeri.setArvo(BigDecimal.ZERO);
