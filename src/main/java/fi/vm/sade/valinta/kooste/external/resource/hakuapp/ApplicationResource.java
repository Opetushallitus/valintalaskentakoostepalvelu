...
public interface ApplicationResource {
  ...
  // @PreAuthorize("hasAnyRole('ROLE_APP_HAKEMUS_READ_UPDATE',
  ...
  public List<Hakemus> getApplicationsByOid(@QueryParam("asId") String hakuOid, @QueryParam("aoOid") String aoOid,
      @QueryParam("appState") List<String> appStates, @QueryParam("rows") int rows);
