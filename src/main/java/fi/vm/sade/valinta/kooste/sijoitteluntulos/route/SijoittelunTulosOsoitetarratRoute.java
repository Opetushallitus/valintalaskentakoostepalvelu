...
public interface SijoittelunTulosOsoitetarratRoute {
  final String SEDA_SIJOITTELUNTULOS_OSOITETARRAT_HAULLE = "seda:sijoitteluntulos_osoitetarrat_haulle?" +
  ...
  void osoitetarratHaulle(@Property(ValvomoAdminService.PROPERTY_VALVOMO_PROSESSI) SijoittelunTulosProsessi prosessi,
      @Property(OPH.HAKUOID) String hakuOid, @Property(OPH.SIJOITTELUAJOID) String sijoitteluAjoId,
