...
public class YoToAvainSuoritustietoDTOConverter {
    ...
    private static Stream<Arvosana> normalisoi(Arvosana a) {
        if (OSAKOE_ASTEIKKO.equals(a.getArvio().getAsteikko())) {
            ...
            return Stream.of(new Arvosana(a.getId(), a.getSuoritus(),
                    ...
                    oldExamRole(a), a.getArvio(), a.getLisatieto()));
        } else {
            return Stream.of(new Arvosana(a.getId(), a.getSuoritus(),
    ...
    private static ImmutableMap<String, ImmutableMap<String, String>> NEW_EXAM_ROLE_TO_OLD_EXAM_ROLE = ImmutableMap.of(
            "mother-tongue", ImmutableMap.<String,String>builder()
                    .put("A", "11")
                    .put("Z", "11")
                    .put("O", "11")
                    .put("W", "11")
                    ...
                    .build()
            ,
            "mandatory-subject", ImmutableMap.<String,String>builder()
                    .put("CA","21")
                    .put("S2","21")
                    .put("T1","21")
                    .put("E2","21")
                    ...
                    .build()
            ,
            "optional-subject", ImmutableMap.<String,String>builder()
                    .put("A","60")
                    .put("O","60")
                    .put("Z","60")
                    /* END OF 60 */
    ...
    private static Optional<Map<String, String>> oldExamRole(String examId, String newExamRole) {
        return Optional.ofNullable(NEW_EXAM_ROLE_TO_OLD_EXAM_ROLE.getOrDefault(newExamRole, ImmutableMap.of()).get(examId)).map(
                oldExamRole -> ImmutableMap.of(
