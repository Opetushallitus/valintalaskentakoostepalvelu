...
public class DokumenttiProsessiKomponentti {
    private static final Logger LOG = LoggerFactory.getLogger(DokumenttiProsessiKomponentti.class);
    ...
    public DokumenttiProsessi haeProsessi(String id) {
        if (id == null) {
            ...
            throw new RuntimeException("null id:llä hakua dokumenttiprosesseista ei sallita!");
        }
    ...
    public void tuoUusiProsessi(DokumenttiProsessi prosessi) {
        if (prosessi == null || prosessi.getId() == null) {
            ...
            throw new RuntimeException("null prosessin talletusta dokumenttiprosesseihin ei sallita!");
        }
