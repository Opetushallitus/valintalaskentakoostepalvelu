...
public class AsennaCasFilter {
    public static JAXRSClientFactoryBean asennaCasFilter(String webCasUrl, String targetService, String appClientUsername,
            String appClientPassword, JAXRSClientFactoryBean bean, ApplicationContext context) {
