...
public class TarjontaServiceResource {
  ...
  @Operation(summary = "Palauttaa listan hakukohteista annetuilla parametreilla", description = "Palauttaa listan hakukohteista annetuilla parametreilla.")
  public CompletableFuture<ResultV1RDTO<HakutuloksetV1RDTO<HakukohdeHakutulosV1RDTO>>> search(
          ...
          @RequestParam(value ="koulutusastetyyppi", required = false) List<KoulutusasteTyyppi> koulutusastetyyppi,
          @RequestParam(value ="hakuOid", required = false) String hakuOid,
          @RequestParam(value ="organisaatioRyhmaOid", required = false) List<String> organisaatioRyhmaOid,
          @RequestParam(value ="koulutustyyppi", required = false) List<ToteutustyyppiEnum> koulutustyypit,
          @RequestParam(value ="koulutusmoduuliTyyppi", required = false) List<KoulutusmoduuliTyyppi> koulutusmoduulityypit,
    ...
    String queryString =
            UriComponentsBuilder.newInstance()
                    ...
                    .queryParamIfPresent("koulutusmoduuliTyyppi", Optional.ofNullable(koulutusmoduulityypit))
    ...
    return this.tarjontaClient.<ResultV1RDTO<HakutuloksetV1RDTO<HakukohdeHakutulosV1RDTO>>>getJson(
            urlConfiguration.url("tarjonta-service.haku.find") + "?" + queryString,
            Duration.ofMinutes(5),
            new com.google.gson.reflect.TypeToken<ResultV1RDTO<HakutuloksetV1RDTO<HakukohdeHakutulosV1RDTO>>>() {}.getType());
