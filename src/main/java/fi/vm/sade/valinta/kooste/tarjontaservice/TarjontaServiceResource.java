...
public class TarjontaServiceResource {
    ...
    public CompletableFuture<ResultV1RDTO<HakukohdeV1RDTO>> getHakukohde(@PathVariable(name = "hakukohdeOid") String hakukohdeOid) {
    ...
    public CompletableFuture<ResultV1RDTO<HakuV1RDTO>> getHaku(@PathVariable(name = "hakuOid") String hakuOid) {
        return this.tarjontaClient
    ...
    @GetMapping(value = "/rest/v1/haku/{hakuOid}/hakukohdeTulos", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    public CompletableFuture<HakukohdeTulosV1RDTO> getHakuHakukohdeTulos(
            ...
            @RequestParam(value = "organisationGroupOids", required = false) String organisationGroupOidsStr,
        ...
        String queryString =
                UriComponentsBuilder.newInstance()
                        ...
                        .queryParamIfPresent("organisationGroupOids", Optional.ofNullable(organisationGroupOidsStr))
    ...
    public CompletableFuture<ResultV1RDTO<List<HakuV1RDTO>>> find(
        ...
        return this.tarjontaClient
                .<ResultV1RDTO<List<HakuV1RDTO>>>getJson(
