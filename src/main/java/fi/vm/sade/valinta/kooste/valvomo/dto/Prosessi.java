 ...
 */
public class Prosessi implements Comparable<Prosessi>, Timestamped,
		ExceptionStack {
	...
	private Collection<String> exceptions = Collections
	...
	public String toString() {
		return Arrays.toString(new Object[] { getResurssi(), getToiminto(),
				getCreatedAt() });
	}
}
