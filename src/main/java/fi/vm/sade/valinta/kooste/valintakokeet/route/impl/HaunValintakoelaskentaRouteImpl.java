...
public class HaunValintakoelaskentaRouteImpl extends SpringRouteBuilder {
	...
	@Autowired
	public HaunValintakoelaskentaRouteImpl(
			HaeHaunHakemuksetKomponentti haeHaunHakemuksetKomponentti,
			LaskeValintakoeosallistumisetHakemukselleKomponentti laskeValintakoeosallistumisetHakemukselleKomponentti) {
		this.haeHaunHakemuksetKomponentti = haeHaunHakemuksetKomponentti;
		this.laskeValintakoeosallistumisetHakemukselleKomponentti = laskeValintakoeosallistumisetHakemukselleKomponentti;
	}
	...
	public void configure() throws Exception {
		...
		//
				.errorHandler(
						deadLetterChannel(haunValintakoelaskentaDeadLetterChannel()))
				//
		...
		from(yksittainenValintakoelaskenta())
				.errorHandler(
						deadLetterChannel(
								yksittainenValintakoelaskentaDeadLetterChannel())
		...
		return new Processor() {
			public void process(Exchange exchange) throws Exception {
				...
				exchange.setProperty(
						prosessi(),
						new Prosessi("Valintakoelaskenta", "Haulle", exchange
	...
	private String haunValintakoelaskenta() {
		return HaunValintakoelaskentaRoute.SEDA_HAUN_VALINTAKOELASKENTA;
	}
