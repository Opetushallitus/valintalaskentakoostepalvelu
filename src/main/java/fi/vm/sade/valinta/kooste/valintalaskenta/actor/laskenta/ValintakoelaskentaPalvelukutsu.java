 ...
 */
public class ValintakoelaskentaPalvelukutsu extends AbstraktiLaskentaPalvelukutsu implements LaskentaPalvelukutsu {
    ...
    private LaskeDTO muodostaLaskeDTO() {
        ...
        List<ValintaperusteetDTO> valintaperusteet = valintaperusteetPalvelukutsu.getValintaperusteet();
        if (hakemukset == null) {
    ...
    public Palvelukutsu teePalvelukutsu(Consumer<Palvelukutsu> takaisinkutsu) {
        try {
            ...
            try {
                aloitaPalvelukutsuJosPalvelukutsuaEiOlePeruutettu(() -> valintalaskentaAsyncResource.valintakokeet(laskeDTO, laskentaCallback -> takaisinkutsu.accept(ValintakoelaskentaPalvelukutsu.this), failureCallback(takaisinkutsu)));
            } catch (Exception e) {
                LOG.error("Valintakoelaskennan palvelukutsun muodostus epaonnistui virheeseen {}", e.getMessage());
                failureCallback(takaisinkutsu).accept(e);
            }
        } catch (Exception e) {
            LOG.error("LaskeDTO:n muodostus epaonnistui ValintakoelaskentaPalvelukutsulle: {}", e.getMessage());
            failureCallback(takaisinkutsu).accept(e);
        }
        return this;
    }
