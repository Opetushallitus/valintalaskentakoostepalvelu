 ...
 */
@Component
public class SecurityPreprocessori implements Processor {

    public static final String SECURITY_CONTEXT_HEADER = "authentication";

    private static final Logger LOG = LoggerFactory.getLogger(SecurityPreprocessori.class);
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (currentAuth == null) {
            ...
            Authentication newAuth = (Authentication) exchange
                    .getProperty(SecurityPreprocessori.SECURITY_CONTEXT_HEADER);
