...
public class SijoittelunTulosConfig {
    ...
    public SijoittelunTulosOsoitetarratRoute getSijoittelunTulosOsoitetarratRoute(
            ...
            throws Exception {
        return ProxyWithAnnotationHelper.createProxy(context.getEndpoint(osoitetarrat), SijoittelunTulosOsoitetarratRoute.class);
    }
    ...
    public SijoittelunTulosTaulukkolaskentaRoute getSijoittelunTulosTaulukkolaskentaRoute(
            ...
            @Qualifier("javaDslCamelContext") CamelContext context)
            throws Exception {
        return ProxyWithAnnotationHelper.createProxy(context.getEndpoint(taulukkolaskenta), SijoittelunTulosTaulukkolaskentaRoute.class);
    }
}
