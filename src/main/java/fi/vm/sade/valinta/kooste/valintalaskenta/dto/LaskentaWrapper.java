...
public class LaskentaWrapper {
  private static final Logger LOG = LoggerFactory.getLogger(LaskentaWrapper.class);
  ...
  private LaskentaStartParams extractLaskenta(List<LaskentaJaValintaperusteetJaHakemukset> tyot) {
