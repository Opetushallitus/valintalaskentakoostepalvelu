...
public interface TarjontaSyncService {
   ...
   *
   * <p>Fetches a set of hakuOids from tarjonta-service, which represents hakus that should be
   * automatically synchronized periodically. The hakuOids are used to import hakukohteet for every
   * corresponding haku.
   */
