...
public class LaskentaJaValintaperusteetJaHakemukset {
    ...
    public LaskentaJaValintaperusteetJaHakemukset(LaskentaStartParams laskenta, String hakukohdeOid, List<ValintaperusteetDTO> valintaperusteet,
                                                  List<Hakemus> hakemukset, List<ApplicationAdditionalDataDTO> lisatiedot, List<ValintaperusteetHakijaryhmaDTO> hakijaryhmat) {
