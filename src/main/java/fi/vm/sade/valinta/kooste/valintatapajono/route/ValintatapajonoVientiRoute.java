...
public interface ValintatapajonoVientiRoute {
  ...
  void vie(@Property(PROPERTY_VALVOMO_PROSESSI) DokumenttiProsessi prosessi, @Property(HAKUOID) String hakuOid,
      @Property(HAKUKOHDEOID) String hakukohdeOid, @Property(VALINTAPAJONOOID) String valintatapajonoOid);
}
