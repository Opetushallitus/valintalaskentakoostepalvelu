...
public class TunnistamatonHaku implements Haku {
    ...
    public boolean isKorkeakouluhaku() {
        throw new NotImplementedException("Tunnistamaton haku joten ei voida sanoa onko kk-haku!");
    }

    @Override
    public boolean isLisahaku() {
        throw new NotImplementedException("Tunnistamaton haku joten ei voida sanoa onko lisahaku!");
    }
}
