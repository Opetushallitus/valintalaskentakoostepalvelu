...
public class KoostepalveluLauseke<IN, OUT> implements Expression {
  private static final Logger LOG = LoggerFactory.getLogger(KoostepalveluLauseke.class);
  ...
  public KoostepalveluLauseke(Function<IN, OUT> lauseke, BiConsumer<IN, Exception> virheloggaus) {
    this.lauseke = lauseke;
  ...
  public Object evaluate(Exchange exchange, @SuppressWarnings("rawtypes") Class type) {
