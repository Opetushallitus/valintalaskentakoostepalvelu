...
public class HakutoiveenIlmoittautumistila {
    ...
    scala.Option<Ilmoittautumistapa> ilmoittautumistapa;
    String ilmoittautumistila;
    Boolean ilmoittauduttavissa;

    public HakutoiveenIlmoittautumistila(Ilmoittautumisaika ilmoittautumisaika, Option<Ilmoittautumistapa> ilmoittautumistapa, String ilmoittautumistila, Boolean ilmoittauduttavissa) {
