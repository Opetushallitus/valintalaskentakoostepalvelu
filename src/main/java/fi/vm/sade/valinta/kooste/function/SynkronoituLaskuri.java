...
public class SynkronoituLaskuri {
    ...
    private SynkronoituLaskuri(int laskurinAlkuarvo, boolean suoritaVainKerran, SynkronoituToiminto suoritaJokaKerta, SynkronoituToiminto synkronoituToiminto) {
