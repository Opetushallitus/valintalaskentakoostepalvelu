...
public class UrlConfiguration extends OphProperties {
  ...
  protected UrlConfiguration() {
    ...
    addOptionalFiles(
        Paths.get(System.getProperties().getProperty("user.home"), "/oph-configuration/common.properties")
            .toString());
  }
   ...
   *
   * <p>
   * This method initializes a new instance of UrlConfiguration, if one has not
   * yet been initialized. Initialization occurs lazily and uses double checked
   * locking for thread safety (see Joshua Bloch: Effective Java, Item 71: Use
   * lazy initialization judiciously).
   *
