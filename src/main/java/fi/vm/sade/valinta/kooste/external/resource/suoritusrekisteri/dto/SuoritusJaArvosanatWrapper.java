...
public class SuoritusJaArvosanatWrapper {
  ...
  public static final String AM_ERIKOISTUTKINTO_KOMO = "erikoisammattitutkinto komo oid";
  ...
  private static Map<String, String> createKomoToStringMapper() {
    ...
    tmp.put(POO_KOMO, "perusopetuksen oppiaineen oppimäärä");
  ...
  public boolean onHakemukselta() {
    return StringUtils.defaultString(suoritusJaArvosanat.getSuoritus().getMyontaja())
        .startsWith(HAKEMUS_OID_PREFIX);
  }
  ...
  public boolean isPerusopetuksenOppiaineenOppimaara() {
    return POO_KOMO.equals(suoritusJaArvosanat.getSuoritus().getKomo());
  }

  public boolean isOpistovuosi() {
    return OPISTOVUOSI_KOMO.equals(suoritusJaArvosanat.getSuoritus().getKomo());
  }
  ...
  public boolean isValmaOrTelma() {
    return VALMA_KOMO.equals(suoritusJaArvosanat.getSuoritus().getKomo())
