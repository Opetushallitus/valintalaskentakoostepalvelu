...
public class LaskentaParams {
    ...
    public LaskentaParams(String userOID, String haunNimi, String nimi, LaskentaTyyppi laskentatyyppi, Boolean isValintakoelaskenta, Integer valinnanvaihe, String hakuOid, Optional<Maski> maski, boolean isErillishaku) {
