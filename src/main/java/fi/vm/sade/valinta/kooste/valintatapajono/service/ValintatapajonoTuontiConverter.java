...
public class ValintatapajonoTuontiConverter {
    ...
    private static ValintatietoValinnanvaiheDTO haeValinnanVaihe(String valintatapajonoOid, Collection<ValintatietoValinnanvaiheDTO> v) {
    ...
    private static ValintatietoValintatapajonoDTO haeValintatapajono(String valintatapajonoOid, ValintatietoValinnanvaiheDTO v) {
    ...
    private static ValintatietoValinnanvaiheDTO luoValinnanVaihe(final List<ValinnanVaiheJonoillaDTO> ilmanLaskentaaVaiheet,
                                                                 String hakukohdeOid, String hakuOid, Optional<String> valintatapajonoOid) {
        ...
        if (!valintatapajonoOid.isPresent()) {
            ...
            if (ilmanLaskentaaJonot.size() > 1) {
                throw new RuntimeException("ValintatapajonoOidia ei annettu ja löytyi useampia kuin yksi valintatapajono ilman laskentaa");
            }
